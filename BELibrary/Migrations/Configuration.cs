...
namespace BELibrary.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<HospitalManagementDbContext>
    {
        ...
        protected override void Seed(HospitalManagementDbContext context)
        {
            ...
            context.Accounts.AddOrUpdate(c => c.UserName, new Account[] {new Account()
            {
                Id = Guid.NewGuid(),
                FullName = "Quản Trị",
                Phone = "0973 642 032",
            ...
            new Account()
            {
                Id = Guid.NewGuid(),
                FullName = "Test",
                Phone = "0973 642 02222",
                UserName = "test",
                Password = CryptorEngine.Encrypt("1234", true),
                Role = 1,
                Gender = true,
                LinkAvatar = ""
            }});
            ...
            context.Doctors.AddOrUpdate(new Doctor()
            {
                ...
                Address = "aaaa",
                Avatar = "vvvvvv",
                Email = "emasdsa@gmail.com",
                Gender = true,
                Descriptions = "emasdsa@gmail.com",
                Phone = "123456789",
                FacultyId = faculties.FirstOrDefault().Id
            });
        }
    }
}